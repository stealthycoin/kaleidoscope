...
def main():
    ...
    #copy files
    LIB_FILES = ['utilities.py','kaleidoscope.py','consts.py','globs.py','menu.py','appsConfig.py','pagesConfig.py','settingsConfig.py','utilities.py','parser','dictPreamble.py','devConfig.py']
